      ...
      <div className="padding-large text-center" style={{ minHeight: '60vh' }}>
        <div className="container">
          <div className="py-4 py-md-5 px-3">
            ...
            <Link to="/shop" className="btn btn-dark" style={{ fontSize: 'clamp(0.9rem, 2vw, 1rem)', padding: 'clamp(0.5rem, 1.5vw, 0.75rem) 1.5rem' }}>
              Continue Shopping
            </Link>
          </div>
        </div>
            ...
            <div className="col-12 col-lg-8 mb-4 mb-lg-0">
              <div className="card">
                <div className="card-body p-3 p-md-4">
                  ...
                  <div className="d-flex flex-column flex-sm-row justify-content-between gap-2 gap-sm-0 mt-3">
                    <Link to="/shop" className="btn btn-outline-dark btn-sm w-100 w-sm-auto">
                      Continue Shopping
                    </Link>
                    <button
            ...
            <div className="col-12 col-lg-4">
              <div className="card mb-3">
                ...
                <div className="card-body">
                  ...
                  <Link to="/shop" className="btn btn-outline-dark w-100" style={{ fontSize: 'clamp(0.9rem, 2vw, 1rem)', padding: 'clamp(0.5rem, 1.5vw, 0.75rem)' }}>
                    Continue Shopping
                  </Link>
                </div>
              </div>
